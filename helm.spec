...
Source0  : https://github.com/helm/helm/archive/v2.14.3/helm-2.14.3.tar.gz
Source1  : http://localhost/cgit/projects/helm-vendor/snapshot/helm-vendor-2.14.3.tar.xz
...
%prep
%setup -q -n helm-2.14.3
cd ..
%setup -q -T -D -n helm-2.14.3 -b 1
mkdir -p ./
cp -r %{_topdir}/BUILD/helm-vendor-2.14.3/* %{_topdir}/BUILD/helm-2.14.3/./
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568663138
...
cp vendor/github.com/DATA-DOG/go-sqlmock/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_DATA-DOG_go-sqlmock_LICENSE
...
cp vendor/github.com/emicklei/go-restful/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_emicklei_go-restful_LICENSE
...
cp vendor/github.com/jmoiron/sqlx/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_jmoiron_sqlx_LICENSE
...
cp vendor/github.com/lib/pq/LICENSE.md %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_lib_pq_LICENSE.md
cp vendor/github.com/liggitt/tabwriter/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_liggitt_tabwriter_LICENSE
...
cp vendor/github.com/rubenv/sql-migrate/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_rubenv_sql-migrate_LICENSE
cp vendor/github.com/rubenv/sql-migrate/sqlparse/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_rubenv_sql-migrate_sqlparse_LICENSE
...
cp vendor/github.com/spf13/cobra/cobra/cmd/testdata/LICENSE.golden %{buildroot}/usr/share/package-licenses/helm/vendor_github.com_spf13_cobra_cobra_cmd_testdata_LICENSE.golden
...
cp vendor/gopkg.in/gorp.v1/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_gopkg.in_gorp.v1_LICENSE
...
cp vendor/gopkg.in/yaml.v2/NOTICE %{buildroot}/usr/share/package-licenses/helm/vendor_gopkg.in_yaml.v2_NOTICE
...
cp vendor/k8s.io/cloud-provider/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_k8s.io_cloud-provider_LICENSE
...
cp vendor/k8s.io/kubernetes/Godeps/LICENSES %{buildroot}/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_Godeps_LICENSES
...
cp vendor/k8s.io/kubernetes/staging/src/k8s.io/component-base/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_component-base_LICENSE
...
cp vendor/k8s.io/kubernetes/staging/src/k8s.io/csi-translation-lib/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_csi-translation-lib_LICENSE
...
cp vendor/k8s.io/kubernetes/staging/src/k8s.io/node-api/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_node-api_LICENSE
...
cp vendor/k8s.io/utils/third_party/forked/golang/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_k8s.io_utils_third_party_forked_golang_LICENSE
cp vendor/sigs.k8s.io/kustomize/LICENSE %{buildroot}/usr/share/package-licenses/helm/vendor_sigs.k8s.io_kustomize_LICENSE
...
/usr/share/package-licenses/helm/vendor_github.com_DATA-DOG_go-sqlmock_LICENSE
...
/usr/share/package-licenses/helm/vendor_github.com_emicklei_go-restful_LICENSE
...
/usr/share/package-licenses/helm/vendor_github.com_jmoiron_sqlx_LICENSE
/usr/share/package-licenses/helm/vendor_github.com_json-iterator_go_LICENSE
/usr/share/package-licenses/helm/vendor_github.com_lib_pq_LICENSE.md
/usr/share/package-licenses/helm/vendor_github.com_liggitt_tabwriter_LICENSE
...
/usr/share/package-licenses/helm/vendor_github.com_rubenv_sql-migrate_LICENSE
/usr/share/package-licenses/helm/vendor_github.com_rubenv_sql-migrate_sqlparse_LICENSE
...
/usr/share/package-licenses/helm/vendor_github.com_spf13_cobra_cobra_cmd_testdata_LICENSE.golden
...
/usr/share/package-licenses/helm/vendor_gopkg.in_gorp.v1_LICENSE
...
/usr/share/package-licenses/helm/vendor_gopkg.in_yaml.v2_NOTICE
...
/usr/share/package-licenses/helm/vendor_k8s.io_cloud-provider_LICENSE
...
/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_Godeps_LICENSES
...
/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_component-base_LICENSE
/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_csi-api_LICENSE
/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_csi-translation-lib_LICENSE
...
/usr/share/package-licenses/helm/vendor_k8s.io_kubernetes_staging_src_k8s.io_node-api_LICENSE
...
/usr/share/package-licenses/helm/vendor_k8s.io_utils_third_party_forked_golang_LICENSE
/usr/share/package-licenses/helm/vendor_sigs.k8s.io_kustomize_LICENSE
